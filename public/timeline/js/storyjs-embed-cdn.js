...
var onHeadline = function(e, headline) {
    ...
    the_load_time =
        Math.floor((new Date().getTime() - load_time_start) / 100) / 10
    _gaq.push([
        '_trackEvent',
        'Timeline',
        headline,
...
if (typeof embed_path == 'undefined') {
    ...
    var embed_path = _tmp_script_path.substr(
        0,
        _tmp_script_path.lastIndexOf('js/')
    )
}
...
function createStoryJS(c, src) {
    var storyjs_embedjs,
        ...
        storyjs_e_config = {
            ...
            height: '100%',
            source:
                'https://docs.google.com/spreadsheet/pub?key=0Agl_Dv6iEbDadFYzRjJPUGktY0NkWXFUWkVIZDNGRHc&output=html',
            lang: 'en',
            font: 'default',
        ...
        font_presets = [
            {
                ...
                google: [
                    'News+Cycle:400,700:latin',
                    'Merriweather:400,700,900:latin',
                ],
            },
            {
            ...
            },
            {
                name: 'Arvo-PTSans',
                google: [
                    'Arvo:400,700,400italic:latin',
                    'PT+Sans:400,700,400italic:latin',
                ],
            },
            {
                name: 'PTSerif-PTSans',
                google: [
                    'PT+Sans:400,700,400italic:latin',
                    'PT+Serif:400,700,400italic:latin',
                ],
            },
            {
                name: 'PT',
            ...
            },
            {
                ...
                google: [
                    ...
                    'Droid+Serif:400,700,400italic:latin',
                ],
            },
            {
                name: 'Lekton-Molengo',
            ...
            },
            {
                ...
                google: [
                    'Playfair+Display:400,400italic:latin',
                    'Muli:300,400,300italic,400italic:latin',
                ],
            },
            {
                name: 'Rancho-Gudea',
            ...
            },
            {
                ...
                google: [
                    ...
                    'Istok+Web:400,700,400italic,700italic:latin',
                ],
            },
            {
                name: 'Pacifico-Arimo',
                google: [
                    'Pacifico::latin',
                    'Arimo:400,700,400italic,700italic:latin',
                ],
            },
        ]
    if (typeof c == 'object') {
    ...
    if (storyjs_e_config.js.match('locale')) {
        storyjs_e_config.lang = storyjs_e_config.js
            .split('locale/')[1]
            .replace('.js', '')
    ...
    if (storyjs_e_config.js.match('/')) {
        ...
        storyjs_e_config.css =
            path.css + storyjs_e_config.type + '.css?' + js_version
    ...
    if (storyjs_e_config.font == 'default') {
        ...
        if (storyjs_e_config.font.match('/')) {
            ...
            path.font.css =
                path.font.css + storyjs_e_config.font + '.css?' + js_version
        }
